...
```
README file in the main page of package's [Github repository](https://github.com/berserkhmdvhb/aiinsurance) `r fa(name = "github", height = "1em")`
...
# Results and Discussion \label{sec:impl}
