...
3. A pipeline that performs the main processes of this work in a single command. The pipeline takes the processed train and test datsets and outputs the evaluation plots in \ref{sec:evaluation}.
