...
```
# **Introduction**
This report is dedicated to project of a workshop of master of data science at University of Luxembourg, I built the [`aiinsurance`](https://github.com/berserkhmdvhb/aiinsurance). 
