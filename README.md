...
Uinsg package's functions a machine learning classification project was done. The link to project's implementation and a detailed report is provided on [Report](#Report).
