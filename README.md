...
Uinsg package's functions a machine learning classification project was done. Thee link to project's implementation and a detailed report is provided on [Report](#Report).
